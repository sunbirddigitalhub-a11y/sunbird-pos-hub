...
const plans = [
  {
    ...
    features: ["Basic POS", "1 User", "Basic Reports", "Email Support", "Cloud Storage"],
  },
  {
    name: "Business",
    usd: 29, ugx: 105000,
    ...
    features: ["Inventory Management", "Customer Management", "Up to 3 Users", "Advanced Reports", "Priority Support", "Mobile Money Integration"],
  },
  {
    name: "Enterprise",
    usd: 79, ugx: 290000,
    desc: "For large operations.",
    features: ["Unlimited Users", "Multi-Store Support", "Full Analytics", "Priority Support", "Custom Integrations", "Dedicated Account Manager", "API Access"],
  },
];
    ...
    <WebsiteLayout>
      <section className="py-20 bg-gradient-to-b from-[hsl(211,80%,8%)] to-[hsl(220,15%,97%)]">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-[hsl(211,30%,70%)] max-w-xl mx-auto mb-8">No hidden fees. Cancel anytime.</p>

          {/* Currency Toggle */}
          <div className="inline-flex items-center rounded-full bg-[hsl(211,40%,18%)] p-1 border border-[hsl(211,40%,25%)]">
            <button
              onClick={() => setCurrency("usd")}
              className={`px-5 py-2 rounded-full text-sm font-semibold transition-all ${
                currency === "usd"
                  ? "bg-[hsl(211,80%,55%)] text-white shadow-md"
                  : "text-[hsl(211,30%,65%)] hover:text-white"
              }`}
            >
              🇺🇸 USD
            </button>
